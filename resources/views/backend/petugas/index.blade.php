                  ...
                  <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>{{$item->agama}}</td>
                            <td>{{$item->pangkat}}</td>
                            <td>{{$item->tim == null ? '': $item->tim->kode}}</td>
                            <td>
                                <a href="/petugas/edit/{{$item->id}}" class="btn btn-xs bg-gradient-warning"><i class="fas fa-edit"></i></a>
                                <a href="/petugas/delete/{{$item->id}}" class="btn btn-xs bg-gradient-danger" onclick="return confirm('Yakin Menghapus Data Ini?');"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                  </tbody>
